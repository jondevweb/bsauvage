...
class __TwigTemplate_a97a57bc74e5570986260567ae282927 extends Template
{
    private $source;
    private $macros = [];
...
{% block body2 %} 
    <div class=\"container\">
        <div id=\"errorShop\"  class=\"text-center\">
            <a href=\"{{ path('app_home') }}?animation=non&arrow=down\">
                <button class=\"sbutton3\">Retour accueil</button>
            </a>
            <h2>Une erreur est survenue, désolé!</h2>
        </div>
    </div>
{% endblock %} ", "@Twig/Exception/error500.html.twig", "/home/u949507161/domains/brasseriesauvage.online/templates/bundles/TwigBundle/Exception/error500.html.twig");
    }
}
