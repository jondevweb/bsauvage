...
class __TwigTemplate_d4b143f387a092f2f489e9c2d383b8d3 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  177 => 21,  172 => 20,  162 => 19,  150 => 17,  145 => 16,  135 => 15,  114 => 12,  101 => 9,  96 => 8,  86 => 7,  72 => 3,  62 => 2,  39 => 1,);
    }
...
{% block beforeBody %}
    {{ include(\"modal/alcoholWarning.html.twig\") }}     
    {{ include(\"canette/canette.html.twig\") }}   
    <div id=\"white\" class=\"zI4\">
{% endblock %}
{% block endHeader %}   
    </div>
{% endblock %}
{% block body %}
    {{ include(\"titleAnimation/tAnim.html.twig\") }}
    {{ include(\"button/button.html.twig\") }}
{% endblock %}
{% block body2 %}
    {{ include(\"bannerBeer/index.html.twig\") }}
    {{ include(\"actuality/actuality.html.twig\") }}
{% endblock %}
", "home/index.html.twig", "/home/u949507161/domains/brasseriesauvage.online/templates/home/index.html.twig");
    }
}
