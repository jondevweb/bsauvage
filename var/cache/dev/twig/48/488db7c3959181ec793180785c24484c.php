...
class __TwigTemplate_1b4daf3cb1023cd41aa45b6b1e90798f extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "engage/index.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "engage/index.html.twig"));
...
";
    ...
    {
        return array (  217 => 133,  185 => 104,  165 => 87,  147 => 72,  116 => 44,  96 => 27,  86 => 20,  58 => 3,  35 => 1,);
    }
        ...
        <div id=\"engagePresent\">
            ...
            <div>
                ...
                <div class=\"flex\">
                    ...
                    <div class=\"col-3\">
                        <img src=\"{{ asset('img/canette_sauvage.png') }}\" alt=\"\">
                    </div>
                </div>
                <div>
                    <div class=\"flex col-0\">
                        <h5>ELLES SONT 100% RECYCLABLES</h5>
                        <div>
                            <img class=\"pImg\" src=\"{{ asset('img/recycle.png') }}\" alt=\"\">
                        </div>
                    </div>
                    <div class=\"col-80\">
                        <div>
                ...
                <div>
                    <div class=\"flex col-0\">
                        <h5>ELLES PEUVENT DEVENIR DES VELOS</h5>
                        <div>
                            <img class=\"pImg\" src=\"{{ asset('img/alurecyclage.png') }}\" alt=\"\">
                        </div>
                    </div>
                    <div class=\"col-80\">
                        <div>
            ...
            <div>                    
                ...
                <div class=\"col-0 flex\">
                    ...
                    <div class=\"col-3\">
                        <img src=\"{{ asset('img/carton1.jpg') }}\" alt=\"\">
                    </div>
                </div>
            </div>
            <div class=\"col-0\">
                ...
                <div>
                    <div class=\"flex col-0\">
                        <h5>Colis Privé</h5>
                        <div>
                            <img class=\"pImg\" src=\"{{ asset('img/colis_prive.png') }}\" alt=\"\">
                        </div>
                    </div>
                    <div class=\"col-80\">
                        <div>
                ...
                <div>
                    <div class=\"flex col-0\">
                        <h5>Mondial Relay</h5>
                        <div>
                            <img class=\"pImg\" src=\"{{ asset('img/mondial_relay.png') }}\" alt=\"\">
                        </div>
                    </div>
                    <div class=\"col-80\">
                        <div>
            ...
            <div>
                ...
                <div class=\"flex\">
                    ...
                    <div class=\"col-3\">
                        <img class=\"pImg2\" src=\"{{ asset('img/houblon1.jpg') }}\" alt=\"\">
                    </div>
                </div>
            </div>
        </div>
...
{% endblock %}
", "engage/index.html.twig", "/home/u949507161/domains/brasseriesauvage.online/templates/engage/index.html.twig");
    }
}
